...
public class Constant {
    ...
    public static final String NOT_FOUND_COMMENT = "Comment with id=%d was not found";
    ...
    public static final String USER_NOT_CREATOR = "User with id=%d is not the creator of the comment with id=%d";
